            ...
            <?php if (!empty($reservas)): ?>
                <?php foreach ($reservas as $reserva): ?>
                    <tr>
                        ...
                        <td>
                            <a href="index.php?controller=reserva&action=editar&id=<?= $reserva['id_reserva'] ?>">Editar</a> | 
                            <a href="index.php?controller=reserva&action=desactivar&id=<?= $reserva['id_reserva'] ?>" onclick="return confirm('¿Desactivar esta reserva?')">Desactivar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
