    ...
    <table border="1" cellpadding="10">
        ...
        <?php foreach ($productos as $producto): ?>
            <tr>
                ...
                <td>
                    <a href="index.php?controller=producto&action=editar&id=<?= $producto['id_producto'] ?>">Editar</a> |
                    <a href="index.php?controller=producto&action=desactivar&id=<?= $producto['id_producto'] ?>" onclick="return confirm('¿Seguro que deseas desactivar este producto?');">Desactivar</a>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
